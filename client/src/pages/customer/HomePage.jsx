...
import {
  ArrowRight, Star, Sparkles, Shield, Truck, Clock
} from 'lucide-react';
  ...
  return (
    <div className="bg-[#050505]">
      ...
      <section ref={heroRef} className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden pt-28 pb-20">
        ...
        {/* Marquee Trust Bar — auto-scrolling */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="marquee-track flex whitespace-nowrap">
            {[...Array(2)].map((_, setIdx) => (
              <div key={setIdx} className="flex items-center gap-8 sm:gap-12 text-white/25 text-[10px] font-bold uppercase tracking-[0.25em] flex-shrink-0 px-4 sm:px-6">
      ...
      <section className="py-20 sm:py-28 bg-[#070707]">
        <div className="container-luxury">
          ...
          >
            <motion.span variants={fadeUpVariants} className="text-accent text-xs tracking-[0.25em] uppercase font-bold">
              The Lineup
            </motion.span>
            <motion.h2 variants={fadeUpVariants} className="font-display text-3xl sm:text-5xl font-bold mt-3 text-white">
              Featured Fragrances
            </motion.h2>
            <motion.p variants={fadeUpVariants} className="text-white/45 mt-4 max-w-md mx-auto text-sm sm:text-base">
              Five scents. One brand. Zero regrets. Every bottle is a conversation starter.
            </motion.p>
          </motion.div>
          ...
          <div className="text-center mt-12">
            <Link
              to="/shop"
              className="inline-flex items-center gap-2 text-white/60 hover:text-white text-sm font-medium px-6 py-3 rounded-full border border-white/15 hover:border-white/30 hover:bg-white/5 transition-all duration-300"
            >
      ...
      {/* ═══════════════════════════════════════════════════════════
          SPOTLIGHT — New Launch / Hero product
      ═══════════════════════════════════════════════════════════ */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-80px' }}
              ...
              <motion.h2 variants={fadeUpVariants} className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-5 leading-[1.1]">
                Avenues<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-[#FDF5E6] to-accent">
                  Midnight
                </span>
              </motion.h2>
              ...
              <motion.div variants={fadeUpVariants} className="flex gap-4 mb-10">
                <div className="bg-[#111111] border border-white/10 p-4 rounded-2xl flex-1 min-w-[120px] hover:border-accent/25 transition-colors group">
                  <p className="text-3xl font-display font-bold text-white group-hover:text-accent transition-colors">
                    12<span className="text-lg text-accent">+</span>
                  </p>
            ...
            >
              <div className="aspect-[3/4] sm:aspect-square lg:aspect-[4/5] rounded-[2rem] overflow-hidden bg-gradient-to-br from-[#161616] to-[#0A0A0A] border border-white/10 flex items-center justify-center relative group">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-accent/8 blur-[60px] rounded-full group-hover:bg-accent/15 transition-colors duration-700" />
                <motion.div animate={{ y: [-8, 8, -8] }} transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }} className="relative z-10">
                  <span className="text-[160px] sm:text-[200px] drop-shadow-2xl select-none">🧴</span>
                </motion.div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          TOP RATED — 2-col mobile, 4-col desktop
      ═══════════════════════════════════════════════════════════ */}
      <section className="py-20 sm:py-28 bg-[#050505] border-y border-white/5">
        <div className="container-luxury">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants}>
              <Link to="/shop" className="hidden sm:inline-flex items-center gap-2 text-white/50 hover:text-white text-sm font-medium border border-white/10 hover:border-white/25 px-5 py-2.5 rounded-full transition-all">
                See Top Picks <ArrowRight size={14} />
              </Link>
            </motion.div>
          </motion.div>
          ...
          <div className="mt-10 text-center sm:hidden">
            <Link to="/shop" className="inline-flex items-center gap-2 text-white/60 text-sm border border-white/15 px-6 py-3 rounded-full hover:bg-white/5 transition-all">
              Explore Top Picks <ArrowRight size={14} />
            </Link>
          </div>
        </div>
      </section>
      ...
      {/* ═══════════════════════════════════════════════════════════
          WHY AVENUES — 4 pillars
      ═══════════════════════════════════════════════════════════ */}
      <section className="py-20 sm:py-28 bg-[#070707]">
        <div className="container-luxury">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }}
            variants={{ show: { transition: { staggerChildren: 0.08 } } }} className="text-center mb-14">
            <motion.span variants={fadeUpVariants} className="text-accent text-xs tracking-[0.25em] uppercase font-bold">
              Why Choose Us
            </motion.span>
            <motion.h2 variants={fadeUpVariants} className="font-display text-3xl sm:text-5xl font-bold mt-3 text-white">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <motion.div
                ...
                className="text-center p-6 sm:p-8 rounded-2xl border border-white/6 bg-[#0D0D0D] hover:border-accent/20 transition-all duration-300 group"
              >
                <div className="w-14 h-14 mx-auto mb-5 rounded-2xl bg-accent/8 border border-accent/15 flex items-center justify-center group-hover:bg-accent/15 transition-colors">
      ...
      {/* ═══════════════════════════════════════════════════════════
          TESTIMONIALS — Auto-rotating card
      ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="container-luxury">
          ...
          <div className="max-w-2xl mx-auto">
            <motion.div
              ...
              className="bg-[#0D0D0D] border border-white/6 rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/85 text-base sm:text-lg leading-relaxed mb-8 font-light">
            ...
            <div className="flex justify-center gap-2 mt-8">
              {TESTIMONIALS.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${i === currentTestimonial ? 'bg-accent w-7' : 'bg-white/15 w-1.5 hover:bg-white/30'}`}
                />
              ))}
            </div>
          </div>
      ...
      <section className="py-24 relative overflow-hidden border-t border-white/6">
        ...
        <div className="container-luxury text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-display text-3xl sm:text-5xl text-white font-bold mb-5">
              Ready to Make a Statement?
            </h2>
            <p className="text-white/45 text-sm sm:text-lg mb-10 max-w-lg mx-auto font-light">
              Join thousands who found their signature scent. Your next compliment is one click away.
            </p>
            <Link
              to="/shop"
              className="btn-cta group inline-flex items-center gap-2.5 font-bold text-sm px-10 py-4 rounded-full"
            >
              Find Your Scent <ArrowRight size={16} className="group-hover:translate-x-0.5 transition-transform" />
            </Link>
          </motion.div>
        </div>
      </section>
